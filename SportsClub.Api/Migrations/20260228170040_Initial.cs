    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Marcel", 3, new DateTime(2026, 3, 3, 19, 30, 0, 0, DateTimeKind.Local), 4 },
                    { 2, "Coen", 5, new DateTime(2026, 3, 2, 18, 0, 0, 0, DateTimeKind.Local), 6 },
                    { 3, "Freek", 2, new DateTime(2026, 2, 28, 18, 0, 0, 0, DateTimeKind.Unspecified), 7 },
                    { 4, "Miriam", 12, new DateTime(2026, 3, 3, 15, 0, 0, 0, DateTimeKind.Local), 8 },
                    { 5, "Miriam", 12, new DateTime(2026, 3, 5, 15, 0, 0, 0, DateTimeKind.Local), 8 },
                    { 6, "Marcel", 8, new DateTime(2026, 2, 28, 10, 0, 0, 0, DateTimeKind.Local), 9 },
                    { 7, "Laura", 10, new DateTime(2026, 3, 6, 19, 30, 0, 0, DateTimeKind.Local), 12 },
                    { 8, "Emilio", 7, new DateTime(2026, 3, 1, 11, 0, 0, 0, DateTimeKind.Local), 10 },
                    { 9, "Judith", 9, new DateTime(2026, 2, 28, 16, 0, 0, 0, DateTimeKind.Unspecified), 11 },
                    { 10, "Eva", 10, new DateTime(2026, 2, 28, 19, 0, 0, 0, DateTimeKind.Unspecified), 12 },
                    { 11, "Suzanne", 11, new DateTime(2026, 2, 28, 20, 0, 0, 0, DateTimeKind.Unspecified), 13 },
                    { 12, "zelf trainen", 1, new DateTime(2026, 2, 28, 17, 0, 0, 0, DateTimeKind.Unspecified), 3 },
                    { 13, "Robert", 5, new DateTime(2026, 2, 28, 19, 30, 0, 0, DateTimeKind.Unspecified), 2 },
                    { 14, "", 4, new DateTime(2026, 3, 2, 17, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 15, "", 4, new DateTime(2026, 3, 3, 17, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 16, "", 4, new DateTime(2026, 3, 4, 14, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 17, "", 4, new DateTime(2026, 3, 5, 14, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 18, "", 4, new DateTime(2026, 3, 6, 14, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 19, "", 4, new DateTime(2026, 2, 28, 10, 0, 0, 0, DateTimeKind.Local), 5 },
                    { 20, "", 4, new DateTime(2026, 3, 1, 10, 0, 0, 0, DateTimeKind.Local), 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, "groepsles", "Combineer yoga, Thaise massage en acrobatiek met elkaar en je hebt AcroYoga.", 90, "https://bress.nl/wp-content/uploads/2022/09/unnamed-3-1536x1024.jpg", null, "Acro Yoga" },
